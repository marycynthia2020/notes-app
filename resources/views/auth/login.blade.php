<x-layout>
    <form method='POST' action="{{ route('login.store') }}" class='bg-gray-950 max-w-2xl p-10 mx-auto rounded-xl'>
        @csrf
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <button type="submit"
                class="rounded-md bg-indigo-500 px-6 py-2  font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Login</button>
        </div>
    </form>
